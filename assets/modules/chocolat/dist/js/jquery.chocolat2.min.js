! function(t) {
    ...
    function n(e, i) {
        ...
        return this.settings = i, this.elems = {}, this.element = e, this._cssClasses = ["chocolat-open", "chocolat-in-container", "chocolat-cover", "chocolat-zoomable", "chocolat-zoomed"], !this.settings.setTitle && e.data("chocolat-title") && (this.settings.setTitle = e.data("chocolat-title")), this.element.find(this.settings.imageSelector).each(function() {
            s.settings.images.push({
                ...
                hyperlink: t(this).attr("hyperlink"),
    ...
    t.extend(n.prototype, {
        ...
        place: function(t, e) {
            var i, s = this;
            return this.settings.currentImage = t, this.description(), this.hyperlink(), this.pagination(), this.arrows(), this.storeImgSize(e, t), i = this.fit(t, s.elems.wrapper), this.center(i.width, i.height, i.left, i.top, 0)
        },
        ...
        appear: function(t) {
            ...
            clearTimeout(this.settings.timer), this.elems.loader.stop().fadeOut(300, function() {
                ...
                e.elems.hyperlink.attr("href", e.settings.images[t].hyperlink)
            })
        },
        fit: function(e, i) {
        ...
        hyperlink: function() {
            var t = this;            
            this.elems.hyperlink.html(t.settings.images[t.settings.currentImage].hyperlink)
        },
        pagination: function() {
            var t = this,
        ...
        markup: function() {
            ...
            }).appendTo(this.elems.bottom), this.elems.hyperlink = t("<a/>", {
                "class": "chocolat-hyperlink",
                href: ''
