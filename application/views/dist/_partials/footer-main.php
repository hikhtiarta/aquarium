      ...
      <footer class="main-footer">
        <div class="row">
          <div class="col-12 col-sm-6 col-md-6 col-lg-3">
            <p class="footer-title mb-2" style="font-size:20px"><strong class="font-RobotoCondensed-Regular">AQUAWABISABI</strong></p>
          ...
          <div class="col-12 col-sm-6 col-md-6 col-lg-3">
            <p class="footer-title mb-2"><strong class="font-RobotoCondensed-Regular">Explore</strong></p>
            ...
            <a class="footer-link" href="<?= base_url('portfolio') ?>">Portfolio</a>            
          </div>         
          <div class="col-12 col-sm-6 col-md-6 col-lg-3">
            <p class="footer-title mb-2"><b class="font-RobotoCondensed-Regular">Follow</b>
          ...
          <div class="col-12 col-sm-6 col-md-6 col-lg-3">
            <p class="footer-title mb-2"><strong class="font-RobotoCondensed-Regular">Alamat</strong></p>
            <p class=""><?= $address ?></p>    
            <p class="footer-title mb-2"><strong class="font-RobotoCondensed-Regular">Kontak</strong></p>
