...
<head>
  ...
  <!-- Vendor CSS Files -->
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/vendor/bootstrap/css/bootstrap.min.css') ?>" rel="stylesheet">
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/vendor/icofont/icofont.min.css') ?>" rel="stylesheet">
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/vendor/animate.css/animate.min.css') ?>" rel="stylesheet">
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/vendor/font-awesome/css/font-awesome.min.css') ?> " rel="stylesheet">
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/vendor/nivo-slider/css/nivo-slider.css') ?> " rel="stylesheet">
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/vendor/owl.carousel/assets/owl.carousel.min.css') ?> " rel="stylesheet">
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/vendor/venobox/venobox.css')?>" rel="stylesheet">

  <!-- Template Main CSS File -->
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/css/style_page.css') ?>" rel="stylesheet">
    ...
    <div class="container d-flex">
      ...
      <div class="logo mr-auto">
        ...
        <!-- Uncomment below if you prefer to use an image logo -->
         <a href="main"> <img src="<?php echo base_url ('assets/img/logo1.jpeg')?>" alt="" class="img-fluid"></a>
      </div>
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="copyright text-center">
              <p>
                &copy; Copyright <strong>AQUA WABISABI</strong>. All Rights Reserved
              </p>
            </div>
            <div class="credits">
              <!--
            ...
            -->
              Designed by <a href="#">AQUA WABISABI</a>
            </div>
          </div>
        </div>
      </div>
...
<?php $this->load->view('dist/_partials/vendor-js'); ?>
<?php
